...
function bom_enemy() {
    ...
    console.log("Bom ARR: ", arr, randx_enemy, randy_enemy)
    for (let v = 0; v < 10; v++) {
        for (let h = 0; h < 10; h++) {

            if (arr[v][h] == 2 && v != 0 && h != 0 && v != 9) {
                ...
                if (direction == 4) {
                    ...
                    if (direction == 4) {
                        ...
                        if ((arr[v][h + 2] == 0 || arr[v][h + 2] == 1) && (arr[v][h + 3] == 0 || arr[v][h + 3] == 1)) {
                            if (arr[v][h + 3] == 0) {
                                arr[v][h + 3] = 4
                                check_loop = 1
                                paint()
                        ...
                        if ((arr[v + 2][h] == 0 || arr[v + 2][h] == 1) && (arr[v + 3][h] == 0 || arr[v + 3][h] == 1)) {
                            if (arr[v + 3][h] == 0) {
                                arr[v + 3][h] = 4
                                check_loop = 1
                                paint()
